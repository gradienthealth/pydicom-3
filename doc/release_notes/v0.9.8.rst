...
pydicom3 0.9.8 is mainly a consolidation step before moving to official Python 3
compatibility in pydicom3 1.0.  It also reverts the change to using Decimal for
VR of DS (in pydicom3 0.9.7), due to performance issues. DS as Decimal is still
...
* DS values reverted to using float as default (issue 114) due to slow
  ...
  improvement compared with pydicom3 0.9.7 (several revisions up to
  r78ba350a3eb8)
